...
export default function TransitioningPage() {
  ...
  const chips = [
    ...
    isFullyCovered
      ? { label: "Surplus", value: `+${fmt(phase1TakeHome)}` }
      : { label: "Gap",     value: `-${fmt(-phase1TakeHome)}` },
  ].filter(Boolean);
        ...
        <div className="sp-modal-overlay" onClick={() => { setShowDebriefedPromo(false); track("Debriefed Promo Dismissed", {}); }}>
          <div className="sp-modal" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ fontSize: 14, color: "#6b7280", lineHeight: 1.55, marginBottom: 20, textAlign: "center" }}>
              Translate your military experience into a civilian resume at GetDebriefed.co
            </div>
      ...
      {showRatingPrompt && !showDebriefedPromo && !showPopup && (
        <div className="tr-ep-overlay" onClick={() => dismissRatingPrompt("dismissed")}>
          <div className="tr-ep-modal" onClick={e => e.stopPropagation()}>
            ...
            <a href="mailto:support@getdebriefed.co?subject=MilCalc%20Review&body=I%20wanted%20to%20share%20feedback%20about%20MilCalc%3A"
