  ...
  function generatePDF() {
    try {
      ...
      for (let i = 1; i <= pages; i++) {
        ...
        doc.text("Generated by MilCalc · milcalc.app · Estimates only — not financial advice. Tax estimates use 2026 standard deduction and marginal rates. Consult a tax professional.", M, 762, { maxWidth: W - M * 2, lineHeightFactor: 1.6 });
      }
          ...
          <InfoCard title="Monthly Income">
            ...
            <div className="ds-income-row">
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                <div className="ds-sel" style={{ maxWidth: 80 }}>
