...
.ds-field-label {
  font-size: 13px; font-weight: 400; color: #9ca3af; flex-shrink: 0;
  line-height: 1.4;
}
.ds-field-value {
  font-size: 15px; font-weight: 600; color: #f9fafb;
...
.ds-card input[type="number"] {
  ...
  text-align: right; width: 100%; min-height: 32px;
  font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
...
.ds-tg-with-label { flex-direction: column; gap: 10px; }
...
.ds-card .ds-hint + .ds-field-row,
.ds-card .ds-hint + .ds-tg {
  border-top: 1px solid rgba(255,255,255,0.04);
}

/* ── STEP LIST ── */
.ds-steps { padding: 0 1rem 0.875rem; }
.ds-step {
...
.ds-cta {
  ...
  background: #d4a017; border: none; border-radius: 14px;
  color: #0f0f14; font-size: 15px; font-weight: 700;
...
.ds-cta:active { background: #f0c14b; transform: scale(0.99); }
...
.ds-stepper-btn:active { background: rgba(212,160,23,0.12); }
.ds-stepper-val {
...
.ds-share-btn {
  ...
  background: #d4a017;
  color: #0f0f14; border: none; border-radius: 14px;
  font-size: 15px; font-weight: 700; cursor: pointer;
  -webkit-tap-highlight-color: transparent;
  transition: opacity 0.13s; margin-bottom: 1rem;
  font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
}
.ds-share-btn:active { opacity: 0.85; }
`;
